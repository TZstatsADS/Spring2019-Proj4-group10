...
correct_index <- function(num_of_file_name){
  ...
  tesseract_row <- rep(1:length(current_tesseract_txt), tes_lengthperrow)
  ...
  ifcorrectmatrix <- cbind(index, tesseract_row, truthpos, truth_row, ifwordcorrect)
